import {ModalCardPalestranteStyle} from "./Style";
import Botao from "../Botao/Botao";

const ModalCardPalestrante = ({
                                  className,
                                  onClick,
                                  textoBotao,
                                  disabled,
    ...
    return (
        <ModalCardPalestranteStyle className={className}>
            ...
            />
            <div className="informacoes-convidado">
                <div className="nome-convidado">{nomeConvidado}</div>
...
export default ModalCardPalestrante;